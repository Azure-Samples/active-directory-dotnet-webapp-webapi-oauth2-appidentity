...
#>
   ...
   process
   {
    ...
    Write-Host "Removing 'service' (TodoListService-AppIdentity) if needed"
    $app=Get-AzureADApplication -Filter "identifierUris/any(uri:uri eq 'https://$tenantName/TodoListService-AppIdentity')"  
    if ($app)
    {
